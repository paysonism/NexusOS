...
$job = Start-Job { powershell -ExecutionPolicy Bypass -File (Join-Path $using:PSScriptRoot '_run_sdl.ps1') }
...
$c.Close()
Set-Content -Path build/boot_capture.log -Value $sb.ToString() -Encoding ASCII
