...
| L3 callback entry/return | `src/kernel/proc/usermode.asm` | `test_source_guards.ps1` |
| L3 runtime frame offsets | `src/include/l3_runtime.inc` | `tools/check_invariants.ps1` |
| Syscall entry/dispatch | `src/kernel/proc/syscall.asm` | `test_source_guards.ps1` |
| Syscall validation | `src/kernel/proc/syscall_validation.inc` | `test_source_guards.ps1` |
...
| Paging user/kernel split | `src/boot/paging.asm` | `test_source_guards.ps1` |
...
| Cache32Max boot profile | `test_cache32_boot.ps1` | `test_verify_all.ps1` |
| SMP serial markers | `test_smp_boot.ps1` | `test_verify_all.ps1` |

Every structural edit must run `test_verify_all.ps1` before the next split.
